...
class AccountUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'login' => ['required', 'string', 'max:128', Rule::unique(Account::class, 'login')->ignore($this->account)],
            'password' => 'required|string|max:128',
            'phone' => ['required', 'string', 'max:32', Rule::unique(Account::class, 'phone')->ignore($this->account)],
        ];
    }
